...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .post("/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "phone1":"SAMPLE_TEXT", "phone2":"SAMPLE_TEXT", "address1":"SAMPLE_TEXT", "address2":"SAMPLE_TEXT", "idNo":"SAMPLE_TEXT", "note":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
